// =====================================================================
// Vibe Coding block: Instagram Engagement Rate Calculator — Hero
// =====================================================================
// First block on /instagram-engagement-rate-calculator. No email gate.
// Hero shape: fixed NAVY title + cycling PERIWINKLE typing line + sub
// + two cross-link buttons to the TikTok and YouTube calculators.
// =====================================================================
...
// Floating 3D Instagram logos around the hero — own-platform only, varied
// sizes, pulled in close to the centered text. Hidden on mobile.
const FLOATING_LOGOS = [
  { src: INSTAGRAM_LOGO, alt: "Instagram", top: "14%",    right: "12%", size: 96, rotate: 12,  delay: 0,   reverse: false },
  { src: INSTAGRAM_LOGO, alt: "Instagram", top: "22%",    left: "10%",  size: 56, rotate: -10, delay: 0.5, reverse: true  },
  { src: INSTAGRAM_LOGO, alt: "Instagram", bottom: "20%", right: "14%", size: 72, rotate: -16, delay: 1.0, reverse: false },
  { src: INSTAGRAM_LOGO, alt: "Instagram", bottom: "16%", left: "13%",  size: 60, rotate: 18,  delay: 0.3, reverse: true  },
];

const TYPING_WORDS = ["Engagement Rate", "Average Followers", "Average Likes", "Average Saves", "Average Shares"];
...
export default function Block() {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      {/* Floating 3D Instagram logos — desktop only */}
      ...
      <div className="container py-14 md:py-20 lg:py-24 relative">
        <div className="content max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-base md:text-lg text-muted-foreground mt-5 leading-relaxed">
            Try our free calculator to determine influencer engagement rates on Instagram and find out how well influencers connect with their audience.
          </p>
