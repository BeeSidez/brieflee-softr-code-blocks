// =====================================================================
// facebook-ad-video-checker — the whole page as ONE block (v2 holding version).
//
...
// =====================================================================
// Vibe Coding block: Free Tool, Facebook Ad Video Checker (hero + Trojan horse)
// =====================================================================
// Drop into a Softr Vibe Coding block on /free-tool-facebook-ad-video-checker.
//
// Same shape as /free-tool-video-breakdown but Facebook-only:
//   - URL validator restricted to facebook.com / fb.watch
//   - Single floating logo (Facebook)
//   - Typing text cycles Facebook ad-related terms
//   - Writes to Tools with Page = "Facebook Ad Video Checker"
// =====================================================================
...
const ds = datasource.define({
  leadEvents: "325d9c31-695d-4932-a5de-af1a56250d1b", // Brieflee CRM → lead_events
});
...
const OPT_SOURCE  = { id: "b0fcc2cb-5f21-4e7d-8cfb-9642cc494ba3", label: "facebook-ad-video-checker" };
...
const PAGE_FACEBOOK_AD_CHECKER = {
  id: "a94468ec-c816-489f-8c90-761b0ed043fe",
  label: "Facebook Ad Video Checker",
};
...
const HERO_ASSET = {
  ...
  alt: "Brieflee analysing a Facebook ad video frame by frame",
};
...
const FACEBOOK_LOGO = `${LOGO_BASE}facebook-logo-3d-transparent_2026-05.png`;
...
const TYPING_WORDS = ["Facebook ad", "Facebook video", "Meta Reel", "Branded ad", "FB ad"];
...
function HeroSection() {
  ...
  const handleStart = () => {
    setError("");
    if (tab === "url" && !isValidFacebookUrl(url)) {
  ...
  const handleSubmitEmail = async () => {
    ...
    try {
      ...
      const target = `${DEMO_URL}?email=${encodeURIComponent(email.trim())}&intent=facebook-ad-checker`;
      window.location.href = target;
    } catch (e) {
      console.error("=== facebook-ad-checker create failed:", e);
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-14 items-center">
            <div className="space-y-6">
              ...
              <p className="text-base md:text-lg text-muted-foreground max-w-xl leading-relaxed">
                Paste a Facebook video URL or upload a file. In 60 seconds, you'll know
                exactly what's working, what's not, and what to fix before launch. Hook,
                structure, pacing, CTA, all scored.
              </p>
                  ...
                  {tab === "url" ? (
                    <div className="flex flex-col sm:flex-row gap-2 rounded-2xl border border-border bg-card p-2 shadow-[0_10px_40px_-15px_hsl(var(--primary)/0.35)]">
                      ...
                      <Button onClick={handleStart} className="h-14 px-7 text-base font-semibold rounded-xl">
                        Check it<ArrowRight className="ml-2 h-5 w-5" />
                      </Button>
                    </div>
                  ) : (
                    <div className="flex flex-col gap-3">
                      <label className="flex items-center justify-center gap-3 h-32 border-2 border-dashed border-primary/40 bg-primary/[0.04] rounded-2xl cursor-pointer hover:bg-primary/[0.07] hover:border-primary/60 transition-all">
                        ...
                        <span className="text-base text-muted-foreground">
                          {file ? <span className="text-foreground font-medium">{file.name}</span> : "Drop a Facebook ad video file or click to upload"}
                        </span>
              ...
              {step === "loading" && (
                <div className="space-y-4 pt-2 max-w-md rounded-2xl border border-border bg-card p-6 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-base font-semibold text-foreground">Checking your Facebook ad</p>
                  </div>
              ...
              {step === "email" && (
                <div className="space-y-5 pt-2 max-w-md rounded-2xl border border-border bg-card p-6 shadow-[0_20px_60px_-20px_hsl(var(--primary)/0.4)]">
                  <div>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mb-1">Your Facebook ad check runs live</h2>
...
const FEATURE_CARDS = [
  {
    ...
    body:
      "Every visual, audio, and text element in the first 3 seconds, tagged against the patterns from millions of high-performing Facebook ads. See exactly which hook hit and why.",
    ...
    alt: "Brieflee scoring multiple Facebook ad videos with pass and fail flags into a chat report",
  },
  {
        ...
        <div className="content max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mb-12 md:mb-16">
            ...
            <p className="mt-4 text-base md:text-lg text-muted-foreground leading-relaxed">
              Brieflee scores every part of the Facebook ad against the patterns from millions
              of high-performing Facebook ads. You get a remix-ready brief,
              not a vibe check.
            </p>
          </div>
...
const STEPS = [
  {
    ...
    body:
      "Any Facebook ad video, or your own video file. We support any short-form clip under 3 minutes.",
    img: null,
  },
  {
    number: "02",
                    ...
                    {step.img ? (
                      ...
                      <div className="rounded-2xl border-2 border-dashed border-primary/30 bg-primary/[0.04] aspect-[4/3] grid place-items-center p-6 overflow-hidden">
                        <div className="flex items-center justify-center gap-6 md:gap-10">
                          <img
                            src="https://res.cloudinary.com/dchroynzv/image/upload/brieflee_icon_facebook-logo-3d-transparent_2026-05.png"
                            alt="Facebook"
...
//   - How do I analyze a Facebook ad with AI?
...
const FAQS = [
  {
    ...
    a: "An AI tool that breaks down any Facebook ad frame by frame and tells you why it works. Paste a Facebook ad video URL, or upload a file. In about 60 seconds you get a scored report covering hook timing, scene structure, audio, on-screen text, and CTA placement, plus a remix-ready brief you can use for your next video.",
  },
  {
    q: "Is it really free?",
  ...
  {
    q: "Can it analyse any Facebook ad?",
    a: "Yes. Paste any public Facebook ad URL from facebook.com and the tool processes it directly. You can also upload your own MP4 or MOV file if the Facebook ad is private or unpublished.",
  },
  {
    q: "What does the AI actually detect?",
    a: "Hook timing, scene transitions, on-screen text and captions, product visibility, creator face time, audio clarity and music sync, CTA placement, pacing, and engagement patterns. Each element is scored against the patterns from millions of high-performing Facebook ads so you can see what landed and what didn't.",
  },
  {
    q: "Why not just ask ChatGPT to break down a Facebook ad?",
  ...
  },
  {
    ...
    a: "The tool is built for Facebook ad video, so the sweet spot is anything under 3 minutes. Longer videos still run, but the breakdown gets less precise as duration grows because short-form patterns stop applying.",
  },
];
...
// =====================================================================
// Drop into a Softr Vibe Coding block at the bottom of /free-tool-facebook-ad-video-checker.
//
