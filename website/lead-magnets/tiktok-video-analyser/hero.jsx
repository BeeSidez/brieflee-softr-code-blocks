...
export default function Block() {
  ...
  const handleSubmitEmail = async () => {
    ...
    try {
      ...
      toast.success("Your TikTok breakdown is on its way", {
        description: "Check your inbox in a moment.",
      });

      const target = `${SIGNUP_URL}?email=${encodeURIComponent(email.trim())}&intent=tiktok-analyser`;
              ...
              {step === "email" && (
                <div className="space-y-5 pt-2 max-w-md rounded-2xl border border-border bg-card p-6 shadow-[0_20px_60px_-20px_hsl(var(--primary)/0.4)]">
                  <div>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mb-1">Your TikTok breakdown is ready</h2>
