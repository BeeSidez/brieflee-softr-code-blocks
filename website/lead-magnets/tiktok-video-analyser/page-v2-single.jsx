// =====================================================================
// tiktok-video-analyser — the whole page as ONE block (v2 holding version).
//
...
// =====================================================================
// Vibe Coding block: Free Tool, TikTok Video Analyser (hero + Trojan horse)
// =====================================================================
// Drop into a Softr Vibe Coding block on /free-tool-tiktok-video-analyser.
//
// Same shape as /free-tool-video-breakdown but TikTok-only:
//   - URL validator restricted to tiktok.com / vm.tiktok.com
//   - Single floating logo (TikTok)
//   - Typing text cycles TikTok-related terms
//   - Writes to Tools with Page = "TikTok Video Analyser"
//
// SOFTR UI SETUP (one-time):
//   1. Source tab → Database: brieflee leads → Table: Tools
//   2. Actions tab → enable "Add Record" (aliases auto-populate)
...
const ds = datasource.define({
  leadEvents: "a4f74244-8beb-4d99-bb42-f52f051f5a5e", // Brieflee CRM → lead_events
});
...
const OPT_SOURCE  = { id: "69d2a7ca-fc92-4f0f-be42-f8ac70025294", label: "tiktok-video-analyser" };
...
const PAGE_TIKTOK_ANALYSER = {
  id: "26d8a876-4d2d-48e8-996b-fe3b3a4c820f",
  label: "TikTok Video Analyser",
};
...
const TYPING_WORDS = ["TikTok", "TikTok ad", "TikTok video", "Spark Code", "Branded TikTok"];
...
function isValidTikTokUrl(input) {
  ...
  try {
    ...
    return /(^|\.)(tiktok\.com|vm\.tiktok\.com)$/.test(u.hostname);
  } catch {
    return false;
  }
}
...
function HeroSection() {
  ...
  const handleSubmitEmail = async () => {
    ...
    try {
      ...
      const target = `${DEMO_URL}?email=${encodeURIComponent(email.trim())}&intent=tiktok-analyser`;
      window.location.href = target;
    } catch (e) {
      console.error("=== tiktok-analyser create failed:", e);
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-14 items-center">
            <div className="space-y-6">
              ...
              <p className="text-base md:text-lg text-muted-foreground max-w-xl leading-relaxed">
                Paste a TikTok URL or upload a file. In 60 seconds, you'll know exactly
                why it worked and which bits to copy. Hook, structure, pacing, CTA, all
                scored.
              </p>
                      ...
                      <label className="flex items-center justify-center gap-3 h-32 border-2 border-dashed border-primary/40 bg-primary/[0.04] rounded-2xl cursor-pointer hover:bg-primary/[0.07] hover:border-primary/60 transition-all">
                        ...
                        <span className="text-base text-muted-foreground">
                          {file ? (
                            ...
                            "Drop a TikTok video file or click to upload"
                          )}
                        </span>
                        <input
                          type="file"
              ...
              {step === "loading" && (
                <div className="space-y-4 pt-2 max-w-md rounded-2xl border border-border bg-card p-6 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-base font-semibold text-foreground">Analysing your TikTok</p>
                  </div>
              ...
              {step === "email" && (
                <div className="space-y-5 pt-2 max-w-md rounded-2xl border border-border bg-card p-6 shadow-[0_20px_60px_-20px_hsl(var(--primary)/0.4)]">
                  <div>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mb-1">Your TikTok breakdown runs live</h2>
...
const FEATURE_CARDS = [
  {
    ...
    body:
      "Every visual, audio, and text element in the first 3 seconds, tagged against the patterns from millions of high-performing TikToks. See exactly which hook hit and why.",
        ...
        <div className="content max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mb-12 md:mb-16">
            ...
            <p className="mt-4 text-base md:text-lg text-muted-foreground leading-relaxed">
              Brieflee scores every part of the TikTok against the patterns from millions
              of high-performing TikToks. You get a remix-ready brief,
              not a vibe check.
            </p>
          </div>
...
const STEPS = [
  {
    ...
    body:
      "Any TikTok video, or your own video file. We support any short-form clip under 3 minutes.",
    img: null,
  },
  {
    number: "02",
                    ...
                    {step.img ? (
                      ...
                      <div className="rounded-2xl border-2 border-dashed border-primary/30 bg-primary/[0.04] aspect-[4/3] grid place-items-center p-6 overflow-hidden">
                        <div className="flex items-center justify-center gap-6 md:gap-10">
                          <img
                            src="https://res.cloudinary.com/dchroynzv/image/upload/brieflee_icon_tiktok-logo-3d-transparent_2026-05.png"
                            alt="TikTok"
...
//   - How do I analyze a TikTok with AI?
...
const FAQS = [
  {
    ...
    a: "An AI tool that breaks down any TikTok frame by frame and tells you why it works. Paste a TikTok video URL, or upload a file. In about 60 seconds you get a scored report covering hook timing, scene structure, audio, on-screen text, and CTA placement, plus a remix-ready brief you can use for your next video.",
  },
  {
    q: "Is it really free?",
  ...
  },
  {
    ...
    a: "Yes. Paste any public TikTok URL from tiktok.com and the tool processes it directly. You can also upload your own MP4 or MOV file if the TikTok is private or unpublished.",
  },
  {
    q: "What does the AI actually detect?",
    a: "Hook timing, scene transitions, on-screen text and captions, product visibility, creator face time, audio clarity and music sync, CTA placement, pacing, and engagement patterns. Each element is scored against the patterns from millions of high-performing TikToks so you can see what landed and what didn't.",
  },
  {
    q: "Why not just ask ChatGPT to break down a TikTok?",
  ...
  },
  {
    ...
    a: "Brieflee scores video against the same patterns top creative strategists use, trained on millions of high-performing TikToks. It won't predict virality with certainty, no tool can, but it will reliably tell you which hooks, scene patterns, and CTAs are statistically aligned with content that performs.",
  },
  {
    q: "Is it safe to upload a TikTok that hasn't been published yet?",
  ...
  },
  {
    ...
    a: "The tool is built for TikTok video, so the sweet spot is anything under 3 minutes. Longer videos still run, but the breakdown gets less precise as duration grows because short-form patterns stop applying.",
  },
];
...
// =====================================================================
// Drop into a Softr Vibe Coding block at the bottom of /free-tool-tiktok-video-analyser.
//
