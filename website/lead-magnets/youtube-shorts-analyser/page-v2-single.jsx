// =====================================================================
// youtube-shorts-analyser — the whole page as ONE block (v2 holding version).
//
...
// =====================================================================
// Vibe Coding block: Free Tool, YouTube Shorts Analyser (hero + Trojan horse)
// =====================================================================
// Drop into a Softr Vibe Coding block on /free-tool-youtube-shorts-analyser.
//
// Same shape as /free-tool-video-breakdown but YouTube-only:
//   - URL validator restricted to youtube.com / youtu.be
//   - Single floating logo (YouTube Shorts)
//   - Typing text cycles YouTube-related terms
//   - Writes to Tools with Page = "YouTube Shorts Analyser"
// =====================================================================
...
const ds = datasource.define({
  leadEvents: "e9e9389c-ca1b-42b2-8f77-d57df93f07c9", // Brieflee CRM → lead_events
});
...
const OPT_SOURCE  = { id: "9944f8ac-fea1-4532-94f6-cd3f7cad7671", label: "youtube-shorts-analyser" };
...
const PAGE_YOUTUBE_SHORTS_ANALYSER = {
  id: "4331507a-5b52-492d-8a75-755db5dd653c",
  label: "YouTube Shorts Analyser",
};
...
const HERO_ASSET = {
  ...
  alt: "Brieflee analysing a YouTube Short frame by frame",
};
...
const YOUTUBE_LOGO = `${LOGO_BASE}youtube-shorts-logo-3d-transparent_2026-05.png`;
const UPLOAD_LOGO = `${LOGO_BASE}upload-cloud-3d-transparent_2026-05.png`;
const FLOATING_LOGOS = [
  {
    src: YOUTUBE_LOGO, alt: "YouTube Shorts",
...
function HeroSection() {
  ...
  const handleStart = () => {
    setError("");
    if (tab === "url" && !isValidYouTubeUrl(url)) {
      setError("Paste a valid YouTube Shorts URL (youtube.com or youtu.be).");
      return;
    }
    if (tab === "file" && !file) {
  ...
  const handleSubmitEmail = async () => {
    ...
    try {
      ...
      const target = `${DEMO_URL}?email=${encodeURIComponent(email.trim())}&intent=youtube-shorts-analyser`;
      window.location.href = target;
    } catch (e) {
      console.error("=== youtube-shorts-analyser create failed:", e);
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-1">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-[1.05]" style={{ color: NAVY }}>
                  See a Short you love.
                  <br />
                  Break it down in seconds.
                </h1>
                <div className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-[1.05]" style={{ color: PERIWINKLE }} aria-live="polite">
                  <span>{typedWord}</span>
              ...
              <p className="text-base md:text-lg text-muted-foreground max-w-xl leading-relaxed">
                Paste a YouTube Shorts URL or upload a file. In 60 seconds, you'll know
                    ...
                    <div className="flex flex-col gap-3">
                      <label className="flex items-center justify-center gap-3 h-32 border-2 border-dashed border-primary/40 bg-primary/[0.04] rounded-2xl cursor-pointer hover:bg-primary/[0.07] hover:border-primary/60 transition-all">
                        ...
                        <span className="text-base text-muted-foreground">
                          {file ? <span className="text-foreground font-medium">{file.name}</span> : "Drop a Short video file or click to upload"}
                        </span>
              ...
              {step === "loading" && (
                <div className="space-y-4 pt-2 max-w-md rounded-2xl border border-border bg-card p-6 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-base font-semibold text-foreground">Analysing your Short</p>
                  </div>
              ...
              {step === "email" && (
                <div className="space-y-5 pt-2 max-w-md rounded-2xl border border-border bg-card p-6 shadow-[0_20px_60px_-20px_hsl(var(--primary)/0.4)]">
                  <div>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mb-1">Your Short breakdown runs live</h2>
...
const FEATURE_CARDS = [
  {
    ...
    body:
      "Every visual, audio, and text element in the first 3 seconds, tagged against the patterns from millions of high-performing Shorts. See exactly which hook hit and why.",
    ...
    alt: "Brieflee scoring multiple Short videos with pass and fail flags into a chat report",
  },
  {
        ...
        <div className="content max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mb-12 md:mb-16">
            ...
            <p className="mt-4 text-base md:text-lg text-muted-foreground leading-relaxed">
              Brieflee scores every part of the Short against the patterns from millions
              of high-performing Shorts. You get a remix-ready brief,
              not a vibe check.
            </p>
          </div>
...
const STEPS = [
  {
    ...
    body:
      "Any YouTube Short, or your own video file. We support any short-form clip under 3 minutes.",
    img: null,
  },
  {
    number: "02",
                    ...
                    {step.img ? (
                      ...
                      <div className="rounded-2xl border-2 border-dashed border-primary/30 bg-primary/[0.04] aspect-[4/3] grid place-items-center p-6 overflow-hidden">
                        <div className="flex items-center justify-center gap-6 md:gap-10">
                          <img
                            src="https://res.cloudinary.com/dchroynzv/image/upload/brieflee_icon_youtube-shorts-logo-3d-transparent_2026-05.png"
                            alt="YouTube Shorts"
...
//   - How do I analyze a Short with AI?
...
const FAQS = [
  {
    ...
    a: "An AI tool that breaks down any Short frame by frame and tells you why it works. Paste a YouTube Short URL, or upload a file. In about 60 seconds you get a scored report covering hook timing, scene structure, audio, on-screen text, and CTA placement, plus a remix-ready brief you can use for your next video.",
  },
  {
    q: "Is it really free?",
  ...
  {
    q: "Can it analyse any Short?",
    a: "Yes. Paste any public Short URL from youtube.com and the tool processes it directly. You can also upload your own MP4 or MOV file if the Short is private or unpublished.",
  },
  {
    q: "What does the AI actually detect?",
    a: "Hook timing, scene transitions, on-screen text and captions, product visibility, creator face time, audio clarity and music sync, CTA placement, pacing, and engagement patterns. Each element is scored against the patterns from millions of high-performing Shorts so you can see what landed and what didn't.",
  },
  {
    q: "Why not just ask ChatGPT to break down a Short?",
  ...
  },
  {
    ...
    a: "Brieflee scores video against the same patterns top creative strategists use, trained on millions of high-performing Shorts. It won't predict virality with certainty, no tool can, but it will reliably tell you which hooks, scene patterns, and CTAs are statistically aligned with content that performs.",
  },
  {
    q: "Is it safe to upload a Short that hasn't been published yet?",
  ...
  },
  {
    ...
    a: "The tool is built for Short video, so the sweet spot is anything under 3 minutes. Longer videos still run, but the breakdown gets less precise as duration grows because short-form patterns stop applying.",
  },
];
...
// =====================================================================
// Drop into a Softr Vibe Coding block at the bottom of /free-tool-youtube-shorts-analyser.
//
