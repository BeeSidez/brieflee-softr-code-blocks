// =====================================================================
// Vibe Coding block: Meta Andromeda Readiness — Final CTA
// =====================================================================
// Last block on /facebook-creative-calculator. Same closing pattern as
// the homepage final-cta: light radial halo, eyebrow + headline + sub +
// two-button row. No contained navy panel (less premium than the light
// treatment).
// =====================================================================
  ...
  return (
    <style>{`
      ...
      .cta-secondary {
        ...
        padding: 16px 26px;
        background: rgba(255,255,255,0.6); color: ${NAVY};
        font-size: 16px; font-weight: 700; letter-spacing: -0.005em;
        border-radius: 12px; text-decoration: none;
