// Marketing site — PLAN block (lifted PricingStep design from /get-started).
// Anonymous; lives on the public marketing pricing page. No useRecords /
// useCurrentUser. Click a card → selected → click sticky CTA → /sign-up
// with the picked tier + interval as query params so the post-signup flow
// can resume on the right plan.
