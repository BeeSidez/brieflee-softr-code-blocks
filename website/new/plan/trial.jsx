// Marketing site — TRIAL block (anonymous variant of app/plans/trial).
// Identical 3-card grid + trust strip + customer logos + sticky CTA as
// app/plans/trial; the only differences are no Softr data binding and
// the sticky CTA routes to /sign-up?plan=<tier>&interval=<interval>
// instead of a per-user Stripe Payment Link. Post-signup flow can read
// the query params and resume on the picked plan.
...
// Trust strip - grey 3D engravings (lifted from /get-started)
const TRUST_ICONS = {
...
// Customer logo strip (lifted from /get-started)
...
const PLANS = [
  { id: "MOFJ50J3sX5cQ4", tier: "Creator", interval: "Monthly", price: 59,
    ...
    maxVideos: 30, maxWorkspaces: 1, maxUsers: 1, rank: 0 },
  ...
  { id: "3DudH4fLuqChIr", tier: "Crew", interval: "Monthly", price: 99,
    ...
    maxVideos: 100, maxWorkspaces: 5, maxUsers: 5, popular: true, rank: 1 },
  ...
  { id: "AQI1eTOfZOYM5h", tier: "Studio", interval: "Monthly", price: 249,
    ...
    maxVideos: 500, maxWorkspaces: 10, maxUsers: 10, rank: 2 },
...
export default function Block() {
  ...
  const handleContinue = () => {
    ...
    const tier = selectedPlan.tier.toLowerCase();
      ...
      <div className="gs-page">
        ...
        <div className="sticky-cta">
          ...
          <button className={"bl-btn bl-btn-primary" + (canContinue ? " pulse" : "")}
            ...
            Start your {TRIAL_DAYS}-day trial <I.ArrowRight size={14} />
          </button>
        </div>
      </div>
    </div>
